...
var NTI469762074 = {size: 0, kind: 24, base: null, node: null, finalizer: null};
NTI469762074.base = NTI33554440;
...
function nimSetTodo_469762058(todo_469762059) {
    ...
    todos_469762088 = nimCopy(null, (JSON.parse((todosStorage_469762080))), NTI469762074);
    }
...
function nimLoadTodos_469762140() {
  ...
  BeforeRet: do {
    ...
    var todos_469762179 = nimCopy(null, Temporary1, NTI469762074);
...
function nimDeleteTodo_469762183(num_469762184) {
  ...
  BeforeRet: do {
    ...
    var todos_469762222 = [nimCopy(null, Temporary1, NTI469762074)];
    if ((((num_469762184) | 0) <= (todos_469762222[0]).length)) {
    break BeforeRet;
    }
    
    delete_469762227(todos_469762222, 0, chckRange(((num_469762184) | 0), 0, 2147483647));
